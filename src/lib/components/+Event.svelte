...
>
  ...
  <div class="p-5 flex flex-col gap-4">
    ...
    <div class="pt-1">
      {#if isOrganizer}
        <div
          class="w-full flex items-center justify-center gap-2 py-2 rounded-full border border-green-200 bg-green-50/50 text-green-700 text-sm font-bold uppercase tracking-widest"
        >
